...
: ${AMENT_CURRENT_PREFIX:="/home/gurupranav/Programming/ros2_tut/igvc/install/rplidar_ros"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rplidar_ros/environment/pythonpath.sh"
